...
public class ScissorsButton extends EntityButton {
    ...
    public void editStyle(RPSParty game) {
        skin.add("Scissors", game.getAssetManager().get("scissors.png"));//a imagem e primeiro posta numa skin porque Skin consegue converter o seu conteudo em diferentes tipo como Drawable que e o que nos precisamos para atribuir uma imagem ao butao
